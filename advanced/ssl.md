...
```
curl -L https://downloads.portainer.io/ee2-20/portainer-agent-stack-ssl.yml -o portainer-agent-stack.yml
```

**Community Edition:**

```
curl -L https://downloads.portainer.io/ce2-20/portainer-agent-stack-ssl.yml -o portainer-agent-stack.yml
```
{% endtab %}
...
```
curl https://downloads.portainer.io/ee2-20/portainer-windows-stack-ssl.yml -o portainer-agent-stack.yml
```

**Community Edition:**

```
curl https://downloads.portainer.io/ce2-20/portainer-windows-stack-ssl.yml -o portainer-agent-stack.yml
```
{% endtab %}
{% endtabs %}
