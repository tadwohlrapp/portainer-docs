...
You can add an environment to manage [via the Portainer API](../administering-portainer/environments/add/api.md), or via the web interface both during the initial setup and after setup is complete.
