...
tb9gtxc647fw   portainer-agent_agent   global       3/3        portainer/agent:2.20.2
m3a3mtuy55ed   portainer_portainer     replicated   1/1        portainer/portainer-ee:2.20.2  *:8000->8000/tcp, *:9000->9000/tcp
```
...
docker service update --image portainer/portainer-ee:2.20.3 --publish-add 9443:9443 --force portainer_portainer
```
{% endtab %}
